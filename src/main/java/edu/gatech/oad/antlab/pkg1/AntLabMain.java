 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person2 p2 = new Person2("Sam Jijina");
		  toPrint += p2.toString("sjijina3");

		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Wendell");
		  toPrint += p3.toString("wbaptiste6");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Camille");
                  toPrint += p4.toString("cpettit6");
